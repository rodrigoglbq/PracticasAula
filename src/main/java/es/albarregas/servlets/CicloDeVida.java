...
public class CicloDeVida extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        System.out.println("Esto es el método Init" + config.getServletName());
    }

    @Override
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {

        System.out.println("Esto es el método Service " + req.getServletPath());
    }

    @Override
    public void destroy() {
        System.out.println("Esto es el método Destroy");
    }
